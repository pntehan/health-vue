    ...
    <div class="login-main">
      <div class="main-panel">
        <div class="panel-left">
          <img src="@/assets/teacher.jpg" class="left-image" />
        </div>
        <div class="panel-right">
          <div class="panel-head">
            <div class="head-line-left"></div>
            <div class="head-title">大学生心理健康系统 - 教师登陆</div>
            <div class="head-line-right"></div>
          </div>
          <el-form :model="form" :rules="rules" ref="login">
            <el-form-item prop="id">
              <el-input v-model="form.id" placeholder="工号" class="inputLength">
            ...
            <div class="tip">Tips : 请输入您的工号与密码。</div>
